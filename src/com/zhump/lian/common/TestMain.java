...
//		System.out.println("设置行业:"+industry);
		...
		JSONObject industryData = WeiXinUtils.getIndustryData(accessToken);
...
//		System.out.println("模板id:"+templateId);
		//获取模板列表
		JSONObject templateList = WeiXinUtils.getTemplateList(accessToken);
		...
		//发送模板
		JSONObject sendTemplate = WeiXinUtils.sendTemplate(createTemplatePojo, accessToken);
